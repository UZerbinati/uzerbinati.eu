...
The courses composes of 4 lectures, each lasting one hour and practical exercises making use of the finite element library [Firedrake](https://www.firedrakeproject.org/).
